...
function Home() {
  return (
    <div className='bg-[orange] h-[824px] flex items-center justify-between w-full'>
        <div>
        ...
        <div className='flex flex-col ml-60'>
          <h1 className='text-[70px] font-raleway font-semibold mb-5'><span className='text-white'>Welcome</span> to <br/> The World of <br/> Tasty & Fresh Food</h1>
          <p className='text-[25px] font-poppins text-white'>Enjoy a variety of options with quick <br/> delivery and great service!</p>
        </div>
